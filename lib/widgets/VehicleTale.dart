...
class VehicleTale extends StatelessWidget {
  const VehicleTale({
    super.key, required this.vehiclename, required this.model, required this.tutorname, required this.location, required this.image,
  });
              ...
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                  ...
                  children: [
                    ...
                    SizedBox(height: 8.h,),
                    Apptext3(text: model, textcolor: hashcolor, size: 10.sp, weight: FontWeight.w400),
                    SizedBox(height: 5.h,),
                    Row(
                      children: [
