...
class StudentsessionPendingScreen extends StatelessWidget { // Tutor session Pending screen........................
  const StudentsessionPendingScreen({super.key});
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView(children: const [
          ...
          StudentSessionTale(date: "13 - 03 - 2023", day: "Sunday", time: "12:00 AM", status: false), // if status true true session is finished..........
